...
switch (global.class_state) {
	...
	case 4: 
		text = "Hoy vimos recursividad que es cuando una función se llama a sí misma para resolver un problema, pilas que son estructuras tipo, último en entrar primero en salir, colas que son primero en entrar primero en salir, y métodos de ordenamiento. También aprendimos métodos de ordenamiento, que son formas de organizar datos dentro de un programa; algunos ejemplos son el método burbuja o quicksort, cada uno con su propia estrategia y eficiencia según la cantidad de ddatos.";
